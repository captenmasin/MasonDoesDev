...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "flex flex-col md:flex-row md:items-center pb-20" },
    [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "w-full md:w-9/12 relative" }, [
        _c("div", { staticClass: "aspect-ratio-16/9" }),
        _vm._v(" "),
        _c("div", {
          staticClass:
            "absolute top-5 left-5 md:top-10 md:left-10 w-full h-full object-cover bg-blue-900 opacity-50"
        }),
        _vm._v(" "),
        _c("img", {
          directives: [
            {
              name: "lazy",
              rawName: "v-lazy",
              value: "../../img/lou-and-mas.jpg",
              expression: "'../../img/lou-and-mas.jpg'"
            }
          ],
          staticClass: "absolute top-0 right-0 w-full h-full object-cover"
        }),
        _vm._v(" "),
        _c("div", {
          staticClass:
            "absolute top-0 right-0 w-full h-full object-cover bg-red-600 blend-darken"
        })
      ])
    ]
  )
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "w-full mt-10 md:mt-0 md:w-3/12 relative" },
      [
        _c(
          "div",
          {
            staticClass:
              "absolute top-0 left-0 xl:left-0 md:whitespace-nowrap z-10"
          },
          [
            _c(
              "h1",
              {
                staticClass:
                  "text-yellow-300 text-3xl md:text-5xl\t-mt-8 word-wrap-break flex flex-col xl:flex-row"
              },
              [
                _c("span", [_vm._v("A random guy ")]),
                _c("span", [_vm._v("who makes things")])
              ]
            ),
            _vm._v(" "),
            _c("p", { staticClass: "text-lg md:text-xl text-yellow-300" }, [
              _vm._v(
                "\n                Professional developer in the most non-professional sense"
              ),
              _c("br"),
              _vm._v(
                "with a real love for code and all\n                things web-y\n            "
              )
            ])
          ]
        )
