...
### CMS & Platforms
- WordPress (custom themes, plugins, ACF-heavy builds)
- Headless and hybrid CMS approaches

### DevOps & Tools
- Linux (Ubuntu servers, Apache/Nginx)
- Vite
- Git (branching, CI/CD workflows)
- Deployment pipelines and server management
